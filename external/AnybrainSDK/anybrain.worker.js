...
const SetCredentials = Module.cwrap("AnybrainSetCredentials", "number", [
  "string",
  "string",
]);
const SetUserId = Module.cwrap("AnybrainSetUserId", "number", ["string"]);
const SetScreenInfo = Module.cwrap("AnybrainSetScreenInfo", null, [
  "number",
  "number",
]);
const SetKeyboardCallback = Module.cwrap("AnybrainSetKeyboardCallback", null, [
  "number",
  "string",
]);
const SetMouseCallback = Module.cwrap("AnybrainSetMouseCallback", null, [
  "number",
  "number",
  "number",
  "number",
...
const ReportError = Module.cwrap("AnybrainReportError", "number", [
  "string",
  "string",
]);
const GetErrorDescription = Module.cwrap(
  "AnybrainGetErrorDescription",
  "string",
  ["number"]
);
onmessage = (e) => {
